...
Crossing this global matrix requires evaluating $3 \times 3 \times 4 = 36$ distinct cell nodes. Running 150 high-cycle trials per cell node means executing **5,400 long-context test cycles**, which can easily exhaust development compute budgets if run blindly.
